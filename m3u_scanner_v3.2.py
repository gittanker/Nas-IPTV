...
class M3UScannerApp:
    ...
    def _draw_header(self):
        ...
        print(Term.color("║", Term.CYAN) + Term.color("           M3U源扫描整理工具 v3.2 - 终端版                  ", Term.YELLOW, bold=True) + Term.color("║", Term.CYAN))
        print(Term.color("║", Term.CYAN) + Term.color("  6大分组 | 固定文件名导出 | 去重留快 | 自动删超时                ", Term.DIM) + Term.color("║", Term.CYAN))
        print(Term.color("╚══════════════════════════════════════════════════════════════╝", Term.CYAN))
        print()
